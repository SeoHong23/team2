  ...
  return (
    <div id="admin-index-container">
      <section className="admin-index-top">
        <article className="admin-index-top-left">
          <div className="admin-index-top-project">
            <AdminCard1 AdminCard1 type="user" location="0" />
            <AdminCard1 type="project" location="0" />
            <AdminCard1 type="outsourcing" location="0" />
          </div>
        </article>
      ...
      <section className="admin-index-bot">
        <AdminCard2 title="공지사항" location="0" type="info" />
        <AdminCard2 title="일정" location="0" type="schedule" />
        <AdminCard2 title={finalDate} location="0" type="calendar" />
        <AdminCard2 title="TO" location="0" type="to" />
      </section>
    </div>
  );
}
